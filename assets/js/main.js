...
const portfolioItems = [
  {
    ...
    title: "SEES",
    description: "A polished, responsive business website built for clear service discovery and conversion.",
    imgSrc: "assets/img/portfolio/sees.webp",
  ...
  },
  {
    ...
    category: "filter-Next",
    title: "Nectos",
    description: "A modern product interface focused on usability, responsive layouts, and fast navigation.",
  ...
  },
  {
    ...
    title: "Xdagreef Pool",
    description: "A responsive dashboard experience for viewing pool and network information.",
    imgSrc: "assets/img/portfolio/xdag.webp",
    previewImg: "assets/img/portfolio/xdag.webp",
  ...
  },
  {
    ...
    description: "A data-focused dashboard with clear navigation and reusable interface components.",
  ...
  },
  {
    ...
    description: "A responsive technology-services website with structured service and company content.",
...

  {
    ...
    description: "A conversion-focused marketing website implemented as a responsive React interface.",
...

  {
    ...
    category: "filter-react",
    title: "Qarby",
    description: "A responsive React product experience with a clean, accessible user interface.",
...

  {
    ...
    description: "A modern technology-company website built with reusable React components.",
...

  {
    ...
    imgSrc: "assets/img/portfolio/7.webp",
    previewImg: "assets/img/portfolio/7.webp",
  ...
  },
  {
    ...
    title: "Frame Up",
    description: "A WordPress website customized for clear content presentation and responsive browsing.",
  ...
  },
  {
    ...
    category: "filter-react",
    title: "Zenara",
    description: "A responsive React interface designed around simple navigation and visual consistency.",
  ...
  },
  {
    ...
    category: "filter-react",
    title: "Coin Network",
    description: "A cryptocurrency-themed React interface with responsive information layouts.",
  ...
  },
  {
    ...
    description: "A custom responsive website developed with HTML, CSS, and JavaScript.",
  ...
  },
  {
    ...
    title: "Thortok",
    description: "A Nuxt-based responsive web interface with component-driven page structure.",
...

  {
    ...
    description: "A responsive marketing interface built with HTML, CSS, and JavaScript.",
    imgSrc: "assets/img/portfolio/marketing.webp",
    previewImg: "assets/img/portfolio/marketing.webp",
  ...
  },
  {
    ...
    description: "A responsive community-focused website with clear content organization.",
  ...
  },
  {
    ...
    category: "filter-htmlcssjs",
    title: "PSD TO HTML",
    description: "A pixel-focused conversion from a static design into responsive HTML and CSS.",
  ...
  },
  {
    ...
    category: "filter-react",
    title: "Flash Cube IT",
    description: "A React website for an IT brand with responsive service and company sections.",
  ...
  },
  {
    ...
    category: "filter-htmlcssjs",
    title: "Zamy Massage",
    description: "A responsive service-business website designed for easy browsing and enquiries.",
    imgSrc: "assets/img/portfolio/zamy.webp",
    previewImg: "assets/img/portfolio/zamy.webp",
...
portfolioItems.forEach((item) => {
  ...
  portfolioItem.innerHTML = `
    ...
    <div class="portfolio-info">
      ...
      <a href="${item.link}" target="_blank" rel="noopener noreferrer" title="Visit live project" class="details-link">
